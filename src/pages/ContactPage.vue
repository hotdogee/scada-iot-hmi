<template>
  <div class="min-h-screen bg-white dark:bg-gray-950">
    <!-- Hero Section -->
    <section
      class="relative bg-gradient-to-b from-amber-50 to-background py-16 pt-20 md:py-24 dark:from-amber-950 dark:to-background"
    >
...
Driven by a lifelong fascination with AI and a deep curiosity about how things work – from fundamental physics to complex biological systems – I engineer innovative solutions where hardware, software, and scientific theory intersect.
...
I’m here to connect with innovators, researchers, and teams who share my vision of pushing human knowledge forward.
          ...
          >
            <div class="space-y-6">
              ...
              <div class="flex items-start">
                ...
                <div class="ml-4">
                  <h3 class="text-lg font-medium text-gray-900 dark:text-white">Let's Connect</h3>
              ...
              <div class="flex items-start">
                ...
                <div class="ml-4">
                  ...
                  <div class="mt-1 space-y-2 text-base">
                    ...
                    <div>
                      <p class="text-gray-600 dark:text-gray-300">B.S., Electronics Engineering</p>
                      <p class="text-sm text-gray-500 dark:text-gray-400">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
          ...
          >
            ...
            <p class="text-base text-gray-600 dark:text-gray-300">
              Deep Learning, Machine Learning, Neural Networks, TensorFlow, Computer Vision, MLOps
            </p>
          </div>
          ...
          >
            ...
            <p class="text-base text-gray-600 dark:text-gray-300">
              Next Generation Sequencing, Proteomics, RNAseq, Microarray Analysis, Molecular Biology
            </p>
          </div>
          ...
          >
            ...
            <p class="text-base text-gray-600 dark:text-gray-300">
              Google Cloud Platform, AWS, Azure, Cloud Architecture, DevOps, Security Engineering
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="mx-auto max-w-3xl">
        ...
        >
          <div class="p-6 sm:p-8">
            <h2 class="mb-4 text-2xl font-bold text-gray-900 dark:text-white">Send a Message</h2>
